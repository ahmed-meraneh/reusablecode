...
/* harmony import */ var _elements_Alert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./elements/Alert */ "./resources/js/elements/Alert.js");

customElements.define("alert-message", _elements_Alert__WEBPACK_IMPORTED_MODULE_0__.Alert);
customElements.define("alert-floating", _elements_Alert__WEBPACK_IMPORTED_MODULE_0__.FloatingAlert);

/***/ }),

/***/ "./resources/js/elements/Alert.js":
/*!****************************************!*\
  !*** ./resources/js/elements/Alert.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "FloatingAlert": () => (/* binding */ FloatingAlert)
/* harmony export */ });
...
var Alert = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(Alert, [{
    ...
    value: function connectedCallback() {
      ...
      this.type = this.getAttribute("type"); // On recupère le texte à l'interieur

      var text = this.innerHTML; // On ajoute les class d'alert

      this.classList.add("alert");
      this.classList.add("alert-".concat(this.type)); // On definit la syntaxe de l'element
...
var FloatingAlert = /*#__PURE__*/function (_Alert) {
  _inherits(FloatingAlert, _Alert);

  var _super2 = _createSuper(FloatingAlert);

  function FloatingAlert() {
    _classCallCheck(this, FloatingAlert);
  ...
  _createClass(FloatingAlert, [{
    ...
    value: function connectedCallback() {
      ...
      if (duration !== null) {
        progressBar = "<div class=\"alert__progress\" style=\"animation-duration: ".concat(duration, "s\">");
        window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
...
/***/ "./resources/js/functions/animations.js":
/*!**********************************************!*\
  !*** ./resources/js/functions/animations.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function _slideUpAndRemove() {
  _slideUpAndRemove = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(element) {
    var duration,
        r,
        _args = arguments;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
